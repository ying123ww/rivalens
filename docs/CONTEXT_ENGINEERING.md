...
- [Evidence Snippets](../rivalens/agents/evidence_snippets.py): KnowledgeStructuringAgent 使用的 accepted evidence 句子级支持片段生成器，输出 success-criterion 级 top-k snippets。
