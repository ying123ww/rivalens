...
- [Coverage Review](../rivalens/agents/coverage_review.py): CollectionAgent 的覆盖审查器，输出 LLM-advised source coverage gap、显式 guiding question / success criteria 缺口和 gap-driven follow-up tasks。
