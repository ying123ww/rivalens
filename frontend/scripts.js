  ...
  const createMCPInfoModal = () => {
    ...
    modal.innerHTML = `
      <div class="mcp-info-content">
        ...
        <p>MCP enables Rivalens to connect with external tools and data sources through a standardized protocol.</p>
...
window.addEventListener('DOMContentLoaded', ResearchEngine.init)
