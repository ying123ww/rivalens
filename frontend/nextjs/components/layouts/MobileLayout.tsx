    ...
    <main className="flex flex-col min-h-screen bg-gray-950">
        ...
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <div className="flex items-center">
            <a href="/" className="flex items-center">
              ...
              />
              <span className="font-medium text-gray-200 text-sm">Rivalens</span>
            </a>
          </div>
      ...
      <footer className="mt-auto py-3 px-4 text-center border-t border-gray-800/40 bg-gray-900/80 backdrop-blur-sm">
        <div className="flex items-center justify-center gap-5 mb-3">
          ...
          <a href="https://hub.docker.com/r/rivalens/rivalens" target="_blank" className="text-gray-400 hover:text-gray-300 transition-colors">
            <img
              src="/img/docker.svg"
              alt="Docker"
              width={20}
