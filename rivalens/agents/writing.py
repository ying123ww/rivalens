...
**步骤一：SWOT 总览表**
先输出一个紧凑的 2×2 表格，每格仅放 3-5 个核心要点关键词 + citation_ref，不展开论述：

| S 优势 | W 劣势 |
| --- | --- |
| 要点1 [1]<br>要点2 [2] | 要点1 [3]<br>要点2 [4] |
| **O 机会** | **T 威胁** |
| 要点1 [5]<br>要点2 [6] | 要点1 [7]<br>要点2 [8] |

表格中每格使用 <br> 换行分隔不同要点，每条要点绑定至少一个 citation_ref。
如果某象限公开证据不足，写"公开证据不足"，不要编造。

**步骤二：各象限深度分析**
紧接表格之后，按以下结构逐一展开（不可只列关键词）：

**S 优势分析**
- 该竞品目前可观察的核心优势是什么？与同类竞品的差距有多大？
- 这些优势能维持多久？竞品做出有力反应需要多长时间？
- 是否有证据表明该优势正在减弱或被追赶？

**W 劣势分析**
- 哪些劣势对该竞品影响最大？是功能缺口、定价问题还是运营短板？
- 该劣势是否正在被市场机会放大？
- 补充该劣势需要多大投入和多长时间？（可从公开信息推断）

**O 机会分析**
- 对该竞品所在赛道，哪些是真正的结构性机会？会持续多久？
- 该竞品在利用这些机会上有什么优势或劣势？
- 有哪些机会是该竞品目前明显忽视或覆盖不足的？

**T 威胁分析**
- 哪些威胁对该竞品是致命的？
- 面对这些威胁，该竞品可能会怎么做？其他竞品在做什么？
- 如果无法规避，该竞品最可能的应对路径是什么？

每段分析必须绑定 citation_ref。信息不足的维度写"公开证据不足，无法展开分析"，不要编造。

### TOWS 战略矩阵

基于以上 SWOT 因子交叉配对，输出 TOWS 战略推演矩阵：
