...
class MCPClientManager:
    ...
    Responsible for:
    - Converting Rivalens MCP configs to langchain format
    ...
    def __init__(self, mcp_configs: List[Dict[str, Any]]):
        ...
        Args:
            mcp_configs: List of MCP server configurations from Rivalens
        """
    ...
    def convert_configs_to_langchain_format(self) -> Dict[str, Dict[str, Any]]:
        """
        Convert Rivalens MCP configs to langchain-mcp-adapters format.
