...
class MCPRetriever:
    """
    Model Context Protocol (MCP) Retriever for Rivalens.
    ...
    async def search_async(self, max_results: int = 10) -> List[Dict[str, str]]:
        ...
        if not self.mcp_configs:
            error_msg = "No MCP server configurations available. Please provide mcp_configs parameter to ResearchEngine."
    ...
    def search(self, max_results: int = 10) -> List[Dict[str, str]]:
        ...
        This is the synchronous interface required by Rivalens.
