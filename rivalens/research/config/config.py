"""Configuration management for Rivalens.

This module provides the Config class that manages all configuration
settings for Rivalens including LLM providers, embeddings,
...
class Config:
    """Configuration manager for Rivalens.
    ...
    def parse_embedding(embedding_str: str | None) -> tuple[str | None, str | None]:
        ...
        from rivalens.research.memory.embeddings import _SUPPORTED_PROVIDERS
