...
_INDUSTRY_FACETS: tuple[dict[str, Any], ...] = (
    ...
    {
        "industry_id": "semiconductor_gpu_ai_chip",
        "name": "半导体 / GPU / AI 芯片",
        "gics_sector": "information_technology",
        "archetypes": ["hardware_manufacturing", "api_infrastructure"],
        "regulated_domains": [],
        "aliases": [
            "半导体",
            "芯片",
        ...
        "competitor_aliases": {
            "NVIDIA": ["nvidia", "英伟达", "辉达"],
            "AMD": ["amd", "超威半导体", "超威"],
            "Intel": ["intel", "英特尔"],
            "Qualcomm": ["qualcomm", "高通"],
            "Huawei Ascend": ["huawei ascend", "华为昇腾", "昇腾"],
            "Google TPU": ["google tpu", "谷歌tpu", "谷歌 tpu"],
            "AWS Trainium": ["aws trainium", "亚马逊trainium", "亚马逊 trainium"],
        },
    },
    {
